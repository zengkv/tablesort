...
tape('uses data-sort-static', function(t) {
  // other column
  var el1 = table.querySelector('th:nth-child(1)');
  // static column
  var el2 = table.querySelector('th:nth-child(12)');
  var event = document.createEvent('HTMLEvents');

  event.initEvent('click', true, false);
  el1.dispatchEvent(event);

  t.equal(table.rows[1].cells[11].innerHTML, '3');
  t.equal(table.rows[2].cells[11].innerHTML, '1');
  t.equal(table.rows[3].cells[11].innerHTML, '2');
